...
console.log(`PAGE_ACCESS_TOKEN: ${config.PAGE_ACCESS_TOKEN ? "已設置" : "未設置"}`);
console.log(`PAGE_ACCESS_TOKEN 長度: ${config.PAGE_ACCESS_TOKEN ? config.PAGE_ACCESS_TOKEN.length : "N/A"}`);
