 ...
 */
const generateAIResponseForNewUser = async (
  userId,
  userMessage,
  options = {}
) => {
 ...
 * @returns {Promise<string>} - AI 生成的回應
 */
const generateAIResponseForOldUser = async (
  userId,
  userMessage,
  options = {}
) => {
...
// 公開方法
module.exports = {
  generateAIResponseForNewUser,
  generateAIResponseForOldUser,
};
